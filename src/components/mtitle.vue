    ...
    <div class="signature">
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 240 51">
          ...
          <div xmlns="http://www.w3.org/1999/xhtml" style="display: flex; align-items: center; height: 100%; justify-content: center;">
              ...
              <svg style="display: inline-block; width: 45px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="10 0 45 51" height="51" width="45">
                  <path class="draw" stroke-dasharray="194" stroke-dashoffset="194" stroke-width="4" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M35.957 3.99976C23.1235 22.025 18.442 31.2217 10.457 47.4998C26.957 5.99983 30.457 37.5 52.957 7.5C33.957 29.4998 32.957 37.6924 29.457 38.5C25.957 39.3076 0.957031 32.5 0.957031 29.4998C23.1446 22.8906 34.5662 20.6514 50.957 22.4998"></path>
              </svg>
              </div>
              <div style="display: inline-flex; align-items: center; margin: 0 -13px 0 -5px;">
              <svg style="display: inline-block; width: 49px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 43 51" height="51" width="49">
                  <path class="draw" stroke-dasharray="128" stroke-dashoffset="128" stroke-width="4" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M16.8032 1.3594C12.7184 0.602171 -1.69718 28.9308 2.30381 28.3593C6.30481 27.7879 33.8032 2.8594 33.8032 2.8594C14.0741 30.0733 5.30273 48.8594 8.80324 49.8594C12.3037 50.8594 30.3027 19.8594 6.80324 39.8594"></path>
              </svg>
              </div>
              <div style="display: inline-flex; align-items: center; margin: 0 0px 0 -1px;">
              <svg style="display: inline-block; width: 37px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="10 0 37 51" height="51" width="37">
                  <path class="draw" stroke-dasharray="101" stroke-dashoffset="101" stroke-width="4" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M30.6585 5.69873C20.8873 19.471 15.4101 28.7219 5.65848 46.1987C22.4604 13.4133 39.6585 11.6987 53.1585 9.69873C64.6585 8.19873 51.1585 20.1987 51.1585 20.1987C80.6585 -7.30127 -1.22332 24.1987 1.15848 37.6987C2.39349 44.6987 37.1585 35.6987 37.1585 35.6987"></path>
              </svg>
              </div>
              ...
              <svg style="display: inline-block; width: 54px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 51" height="51" width="54">
                  <path class="draw" stroke-dasharray="235" stroke-dashoffset="235" stroke-width="4" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M19.2264 13.6837C12.2264 15.1837 -0.773614 43.6837 6.72639 46.1837C14.2264 48.6837 43.2258 13.6837 28.7272 5.68376C13.2266 -2.86957 -2.2744 33.1838 2.22656 40.6838C6.72753 48.1839 20.7264 29.6837 20.7264 29.6837"></path>
              </svg>
              </div>
          </div>
          </foreignObject>
