    ...
    <foreignObject width="100%" height="100%">
      <div xmlns="http://www.w3.org/1999/xhtml"
        ...
        <div style="display: inline-flex; align-items: center; margin: 0 -8px 0 -9px;">
          <svg style="display: inline-block; width: 55px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 55 51" height="51" width="55">
        ...
        <div style="display: inline-flex; align-items: center; margin: 0 -1px 0 -1px;">
          <svg style="display: inline-block; width: 45px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="10 0 45 51" height="51" width="45">
        ...
        <div style="display: inline-flex; align-items: center; margin: 0 -13px 0 -5px;">
          <svg style="display: inline-block; width: 49px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 43 51" height="51" width="49">
        ...
        <div style="display: inline-flex; align-items: center; margin: 0 0px 0 -1px;">
          <svg style="display: inline-block; width: 37px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="10 0 37 51" height="51" width="37">
        ...
        <div style="display: inline-flex; align-items: center; margin: 0 -25px 0 -3px;">
          <svg style="display: inline-block; width: 54px; height: 100%;" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 54 51" height="51" width="54">
